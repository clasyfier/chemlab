# ChemLab — A-Level Chemistry

An interactive study companion for A-level chemistry (AQA / OCR / Edexcel), built as a single self-contained page — no build step, no dependencies.

- **Learn** — 13 topic guides with mark-scheme-worded definitions and verified data
